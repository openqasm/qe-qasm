    ...
    for (unsigned J = 0; J < 3U; ++J) {
      ...
      if (ASTE) {
        ...
        ASTSymbolTable::Instance().EraseLocalSymbol(S.str(),
                                                    AId->GetBits(),
                                                    AId->GetSymbolType());
        ASTSymbolTable::Instance().EraseLocalAngle(S.str(),
                                                   AId->GetBits(),
                                                   AId->GetSymbolType());
      }
    }
    ...
    if (!STE->HasValue()) {
      ...
      if (!QPN) {
        ...
        if (QI == GSTM.end()) {
          ...
          if ((*QI).second->GetValueType() == ASTTypeGateQubitParam) {
  ...
  for (MI = GSTM.begin(); MI != GSTM.end(); ++MI) {
    if ((*MI).second) {
      if ((*MI).second->GetValueType() == ASTTypeGateQubitParam)
        ASTSymbolTable::Instance().EraseGateQubitParam((*MI).second->GetIdentifier());

      ASTSymbolTable::Instance().EraseLocalSymbol((*MI).second->GetIdentifier(),
...
void
ASTGateNode::MaterializeBuiltinUGate(const ASTIdentifierNode* GId,
  ...
  for (ASTParameterList::const_iterator I = PL.begin();
    ...
    ASTSymbolTableEntry* STE =
      ASTSymbolTable::Instance().Lookup(AP->GetName(), ASTAngleNode::AngleBits,
                                        ASTTypeAngle);
    ...
    ASTIdentifierNode* AId = const_cast<ASTIdentifierNode*>(AN->GetIdentifier());
  ...
  for (ASTIdentifierList::const_iterator I = IL.begin(); I != IL.end(); ++I) {
    ...
    ASTSymbolTableEntry* STE =
      ASTSymbolTable::Instance().Lookup(QId->GetName(), QId->GetBits(),
      ...
      try {
        ...
        if (!AN) {
          ...
          ASTIdentifierNode* AId =
            ASTBuilder::Instance().CreateASTIdentifierNode(SAN.str(),
                                   BId->GetBits(), ASTTypeAngle);
          assert(AId && "Could not create an Angle ASTIdentifierNode!");
    ...
    case ASTTypeMPDecimal: {
      try {
        ...
        const ASTIdentifierNode* ID =
          MPD->GetIdentifier()->GetIdentifier();
...
ASTGateNode::ASTGateNode(const ASTIdentifierNode* Id,
  ...
  for (ASTParameterList::const_iterator I = PL.begin();
    ...
    if (ASTTypeSystemBuilder::Instance().IsReservedAngle(AP->GetName())) {
      ...
      assert(STE && "Could not obtain a valid reserved Angle SymbolTable Entry!");
      ...
      if (STE) {
        if (!STE->HasValue()) {
          ASTAngleNode* XAN =
            CreateAngleSymbolTableEntry(const_cast<ASTSymbolTableEntry*>(STE));
          assert(XAN && "Could not create a valid ASTAngleNode!");
        }
    ...
    if (!AN) {
      ASTIdentifierNode* AId =
        ASTBuilder::Instance().CreateASTIdentifierNode(AP->GetName(),
                                                       ASTAngleNode::AngleBits,
                                                       ASTTypeAngle);
      assert(AId && "Could not create an Angle ASTIdentifierNode!");
      ...
      assert(ASTE->HasValue() && "ASTAngleNode SymbolTable Entry has no Value!");
  ...
  for (ASTIdentifierList::const_iterator I = IL.begin();
    ...
    if (QId->IsReference() && (IdR = dynamic_cast<ASTIdentifierRefNode*>(QId))) {
      std::stringstream M;
...
ASTGateControlNode::ASTGateControlNode(const ASTGateNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Ctrl, ASTTypeGateControl),
...
ASTGateControlNode::ASTGateControlNode(const ASTGateNegControlNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Ctrl, ASTTypeGateControl),
  NCN(N), TType(ASTTypeGateNegControl), MV(nullptr), MType(ASTTypeUndefined),
  CBits(1U) {
    N->SetModifier(this);
  }
...
ASTGateNegControlNode::ASTGateNegControlNode(const ASTGPhaseExpressionNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::NegCtrl, ASTTypeGateNegControl),
  GPN(N), TType(ASTTypeGPhaseExpression), MV(nullptr), MType(ASTTypeUndefined),
  CBits(1U) { }
...
ASTGateNegControlNode::ASTGateNegControlNode(const ASTGateGPhaseExpressionNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::NegCtrl, ASTTypeGateNegControl),
  GGEN(N), TType(ASTTypeGateGPhaseExpression), MV(nullptr),
  MType(ASTTypeUndefined), CBits(1U) { }
...
ASTGateInverseNode::ASTGateInverseNode(const ASTGateQOpNode* QN)
  : ASTExpressionNode(&ASTIdentifierNode::Inv, ASTTypeGateInverse),
  GQN(QN), TType(ASTTypeGateQOpNode), MV(nullptr), MType(ASTTypeUndefined)
  { }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNode* N,
  ...
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), GN(N), EType(Exp->GetASTType()), TType(ASTTypeGate),
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNode* N,
  ...
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), GN(N), EType(Exp->GetASTType()), TType(ASTTypeGate),
  MV(nullptr), MType(ASTTypeUndefined) {
  GN->SetPower(this);
}
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNode* N,
  ...
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), GN(N), EType(Exp->GetASTType()), TType(ASTTypeGate),
  MV(nullptr), MType(ASTTypeUndefined) {
  GN->SetPower(this);
}
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNode* N,
  ...
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), GN(N), EType(Exp->GetASTType()), TType(ASTTypeGate),
  MV(nullptr), MType(ASTTypeUndefined) {
  GN->SetPower(this);
}
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateQOpNode* QN)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  GQN(QN), EType(ASTTypeUndefined), TType(ASTTypeGateQOpNode),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateQOpNode* QN,
                                   const ASTIntNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), GQN(QN), EType(Exp->GetASTType()), TType(ASTTypeGateQOpNode),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateQOpNode* QN,
                                   const ASTIdentifierNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), GQN(QN), EType(Exp->GetASTType()), TType(ASTTypeGateQOpNode),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateQOpNode* QN,
                                   const ASTBinaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), GQN(QN), EType(Exp->GetASTType()), TType(ASTTypeGateQOpNode),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateQOpNode* QN,
                                   const ASTUnaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), GQN(QN), EType(Exp->GetASTType()), TType(ASTTypeGateQOpNode),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateControlNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  CN(N), EType(ASTTypeUndefined), TType(ASTTypeGateControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateControlNode* N,
                                   const ASTIntNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), CN(N), EType(Exp->GetASTType()), TType(ASTTypeGateControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateControlNode* N,
                                   const ASTIdentifierNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), CN(N), EType(Exp->GetASTType()), TType(ASTTypeGateControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateControlNode* N,
                                   const ASTBinaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), CN(N), EType(Exp->GetASTType()), TType(ASTTypeGateControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateControlNode* N,
                                   const ASTUnaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), CN(N), EType(Exp->GetASTType()), TType(ASTTypeGateControl),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateNegControlNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  NCN(N), EType(ASTTypeUndefined), TType(ASTTypeGateNegControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNegControlNode* N,
                                   const ASTIntNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), NCN(N), EType(Exp->GetASTType()), TType(ASTTypeGateNegControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNegControlNode* N,
                                   const ASTIdentifierNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), NCN(N), EType(Exp->GetASTType()), TType(ASTTypeGateNegControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNegControlNode* N,
                                   const ASTBinaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), NCN(N), EType(Exp->GetASTType()), TType(ASTTypeGateNegControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateNegControlNode* N,
                                   const ASTUnaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), NCN(N), EType(Exp->GetASTType()), TType(ASTTypeGateNegControl),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGatePowerNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  PN(N), EType(ASTTypeUndefined), TType(ASTTypeGatePower),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGatePowerNode* N,
                                   const ASTIntNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), PN(N), EType(Exp->GetASTType()), TType(ASTTypeGatePower),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGatePowerNode* N,
                                   const ASTIdentifierNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), PN(N), EType(Exp->GetASTType()), TType(ASTTypeGatePower),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGatePowerNode* N,
                                   const ASTBinaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), PN(N), EType(Exp->GetASTType()), TType(ASTTypeGatePower),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGatePowerNode* N,
                                   const ASTUnaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), PN(N), EType(Exp->GetASTType()), TType(ASTTypeGatePower),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateInverseNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  IN(N), EType(ASTTypeUndefined), TType(ASTTypeGateInverse),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateInverseNode* N,
                                   const ASTIntNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), IN(N), EType(Exp->GetASTType()), TType(ASTTypeGateInverse),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateInverseNode* N,
                                   const ASTIdentifierNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), IN(N), EType(Exp->GetASTType()), TType(ASTTypeGateInverse),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateInverseNode* N,
                                   const ASTBinaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), IN(N), EType(Exp->GetASTType()), TType(ASTTypeGateInverse),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateInverseNode* N,
                                   const ASTUnaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), IN(N), EType(Exp->GetASTType()), TType(ASTTypeGateInverse),
  MV(nullptr), MType(ASTTypeUndefined) {
    N->SetModifier(this);
  }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGPhaseExpressionNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  GPN(N), EType(ASTTypeUndefined), TType(ASTTypeGPhaseExpression),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateGPhaseExpressionNode* N)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  GGEN(N), EType(ASTTypeUndefined), TType(ASTTypeGateGPhaseExpression),
  MV(nullptr), MType(ASTTypeUndefined) { }

ASTGatePowerNode::ASTGatePowerNode(const ASTGateGPhaseExpressionNode* N,
                                   const ASTIntNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  I(Exp), GGEN(N), EType(Exp->GetASTType()),
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateGPhaseExpressionNode* N,
                                   const ASTIdentifierNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  ID(Exp), GGEN(N), EType(Exp->GetASTType()),
  TType(ASTTypeGateGPhaseExpression), MV(nullptr), MType(ASTTypeUndefined)
  { }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateGPhaseExpressionNode* N,
                                   const ASTBinaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  BOP(Exp), GGEN(N), EType(Exp->GetASTType()),
  TType(ASTTypeGateGPhaseExpression), MV(nullptr), MType(ASTTypeUndefined)
  { }
...
ASTGatePowerNode::ASTGatePowerNode(const ASTGateGPhaseExpressionNode* N,
                                   const ASTUnaryOpNode* Exp)
  : ASTExpressionNode(&ASTIdentifierNode::Pow, ASTTypeGatePower),
  UOP(Exp), GGEN(N), EType(Exp->GetASTType()),
  TType(ASTTypeGateGPhaseExpression), MV(nullptr), MType(ASTTypeUndefined)
  { }

void
ASTGateControlNode::print() const {
...
void
ASTGateNegControlNode::print() const {
...
void
ASTGateInverseNode::print() const {
...
GateKind
ASTGateNode::DetermineGateKind(const std::string& GN) {
  if (GN == u8"h")
    return ASTGateKindH;
  else if (GN == u8"U")
    return ASTGateKindU;
...
ASTType
ASTGateNode::DetermineGateType(const std::string& GN) {
  std::string N = ASTStringUtils::Instance().ToLower(GN);
  return ASTTypeGate;
}
...
ASTUGateNode*
ASTUGateNode::CloneCall(const ASTIdentifierNode* Id,
                        const ASTArgumentNodeList& AL,
                        const ASTAnyTypeList& QL) {
  assert(Id && "Invalid ASTIdentifierNode argument!");
...
ASTCXGateNode*
ASTCXGateNode::CloneCall(const ASTIdentifierNode* Id,
                         const ASTArgumentNodeList& AL,
                         const ASTAnyTypeList& QL) {
  assert(Id && "Invalid ASTIdentifierNode argument!");
...
ASTCCXGateNode*
ASTCCXGateNode::CloneCall(const ASTIdentifierNode* Id,
                          const ASTArgumentNodeList& AL,
                          const ASTAnyTypeList& QL) {
  assert(Id && "Invalid ASTIdentifierNode argument!");
...
ASTCNotGateNode*
ASTCNotGateNode::CloneCall(const ASTIdentifierNode* Id,
                           const ASTArgumentNodeList& AL,
                           const ASTAnyTypeList& QL) {
  assert(Id && "Invalid ASTIdentifierNode argument!");
      ...
      for (unsigned I = 0; I < Params.size(); ++I) {
        if (Params[I]->IsExpression()) {
          if (const ASTExpressionNode* EXN = Params[I]->GetExpression()) {
            ...
            case ASTTypeBinaryOp: {
              const ASTBinaryOpNode* BOP = dynamic_cast<const ASTBinaryOpNode*>(EXN);
              ...
              break;
            case ASTTypeUnaryOp: {
              const ASTUnaryOpNode* UOP = dynamic_cast<const ASTUnaryOpNode*>(EXN);
...
bool
ASTGateQOpList::TransferToSymbolTable(std::map<std::string,
