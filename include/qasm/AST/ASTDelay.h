...
public:
  ...
  ASTDelayNode(const ASTIdentifierNode* DId,
               const ASTIdentifierList& QIL,
               const std::string& Time = "")
  ...
  virtual ASTBinaryOpNode* GetDelayBinaryOp() {
    return DType == ASTTypeBinaryOp ?
                    const_cast<ASTBinaryOpNode*>(BOP) :
                    nullptr;
  }
  ...
  virtual ASTUnaryOpNode* GetDelayUnaryOp() {
    return DType == ASTTypeUnaryOp ?
                    const_cast<ASTUnaryOpNode*>(UOP) :
                    nullptr;
  }
  ...
  virtual ASTDurationOfNode* GetDurationOfNode() {
    return DType == ASTTypeDurationOf ?
                    const_cast<ASTDurationOfNode*>(DON) : nullptr;
  }
  ...
  virtual ASTDurationNode* GetDurationNode() {
    return DType == ASTTypeDuration ?
                    const_cast<ASTDurationNode*>(DN) : nullptr;
  }
  ...
  virtual ASTStretchNode* GetStretchNode() {
    return DType == ASTTypeStretch ?
                    const_cast<ASTStretchNode*>(STR) : nullptr;
  }
  ...
  virtual ASTType GetDelayType() const {
    return DType;
  }
  ...
  virtual void print() const override {
    ...
    std::cout << "<MangledName>" << GetMangledName() << "</MangledName>"
      << std::endl;
    std::cout << "<DelayType>" << PrintTypeEnum(DType)
      << "</DelayType>" << std::endl;
    std::cout << "<Duration>" << std::dec << Duration
      << "</Duration>" << std::endl;
    std::cout << "<Units>" << PrintLengthUnit(Units)
      << "</Units>" << std::endl;
    switch (DType) {
    case ASTTypeIdentifier:
      Id->print();
...
public:
  ...
  virtual ASTDelayNode* GetDelay() {
    return const_cast<ASTDelayNode*>(Delay);
  }
