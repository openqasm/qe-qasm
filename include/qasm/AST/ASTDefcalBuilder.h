...
#ifndef __QASM_AST_DEFCAL_BUILDER_H
#define __QASM_AST_DEFCAL_BUILDER_H
...
private:
  static ASTDefcalNodeList DL;
  static ASTDefcalNodeMap DM;
  static ASTDefcalBuilder DB;
  static uint32_t DC;
  static bool DCS;
...
public:
  ...
  const_list_iterator begin() const { return DL.begin(); }

  list_iterator end() { return DL.end(); }

  const_list_iterator end() const { return DL.end(); }
};
