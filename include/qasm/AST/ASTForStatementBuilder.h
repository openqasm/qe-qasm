...
#ifndef __QASM_AST_FOR_STATEMENT_BUILDER_H
#define __QASM_AST_FOR_STATEMENT_BUILDER_H
...
class ASTForStatementBuilder {
private:
  static ASTForStatementBuilder FSB;
  static ASTStatementList SL;
  static ASTStatementList *SLP;
  static std::vector<ASTStatementList *> SLV;

protected:
  ASTForStatementBuilder() = default;
...
public:
  static ASTForStatementBuilder &Instance() {
    return ASTForStatementBuilder::FSB;
  }

  ~ASTForStatementBuilder() = default;

  static ASTStatementList *List() { return ASTForStatementBuilder::SLP; }
...
#endif // __QASM_AST_FOR_STATEMENT_BUILDER_H
