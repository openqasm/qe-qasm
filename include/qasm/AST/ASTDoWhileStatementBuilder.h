...
#ifndef __QASM_AST_DO_WHILE_STATEMENT_BUILDER_H
#define __QASM_AST_DO_WHILE_STATEMENT_BUILDER_H
...
class ASTDoWhileStatementBuilder {
private:
  static ASTDoWhileStatementBuilder DWSB;
  static ASTStatementList SL;
  static ASTStatementList *SLP;
  static std::vector<ASTStatementList *> SLV;

protected:
  ASTDoWhileStatementBuilder() = default;
...
public:
  static ASTDoWhileStatementBuilder &Instance() {
    return ASTDoWhileStatementBuilder::DWSB;
  }

  ~ASTDoWhileStatementBuilder() = default;

  static ASTStatementList *List() { return ASTDoWhileStatementBuilder::SLP; }
  ...
  virtual void print() const {
    std::cout << "<DoWhileStatementBuilderList>" << std::endl;
    SLP->print();
    std::cout << "</DoWhileStatementBuilderList>" << std::endl;
  }
};
...
#endif // __QASM_AST_DO_WHILE_STATEMENT_BUILDER_H
