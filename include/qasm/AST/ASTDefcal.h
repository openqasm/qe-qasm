...
public:
  ...
  virtual bool IsDefcalCall() const {
    return IsCall;
  }

  virtual bool HasResult() const {
    return OTy == ASTTypeMeasure && Measure &&
      Measure->HasResult();
  }
  ...
  virtual bool HasQubitTargets() const {
    return !QIL.Empty();
  }
  ...
  virtual bool HasStatements() const {
  ...
  virtual const ASTIdentifierList& GetQubitTargets() const {
    return QIL;
  }

  virtual const ASTExpressionNodeList& GetParameters() const {
    return Params;
  }
  ...
  virtual QubitKind GetQubitKind() const {
    return QK;
  }
  ...
  virtual void SetDefcalCall(bool V = true) {
    IsCall = V;
  }
...
protected:
  ASTDefcalDeclarationNode(const ASTIdentifierNode* Id,
...
public:
  ...
  virtual unsigned Size() const {
    return static_cast<unsigned>(DV.size());
  }
  ...
  ASTDefcalNode* operator[](unsigned IX) {
