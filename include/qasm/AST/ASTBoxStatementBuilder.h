...
#ifndef __QASM_AST_BOX_STATEMENT_BUILDER_H
#define __QASM_AST_BOX_STATEMENT_BUILDER_H
...
class ASTBoxStatementBuilder {
private:
  static ASTBoxStatementBuilder BSB;
  static ASTStatementList VS;

protected:
  ASTBoxStatementBuilder() = default;
