...
public:
  ...
  ASTAnyTypeList(const ASTAnyTypeList &RHS) : Graph(RHS.Graph) {}
  ...
  virtual unsigned Size() const { return static_cast<unsigned>(Graph.size()); }
  ...
  virtual void push(const ASTAnyType &Ty) { Graph.push_back(Ty); }
};
